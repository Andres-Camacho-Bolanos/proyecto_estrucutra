...
void info_graphs(){
    ...
    printf("En programación, un grafo es una estructura de datos no lineal que consiste en un conjunto de nodos y arcos. Los nodos representan los elementos o entidades, mientras que los arcos representan las relaciones o conexiones entre los elementos.\n");
