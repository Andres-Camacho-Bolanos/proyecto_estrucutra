...
void info_queue(){
    ...
    printf("\nEjemplo de uso: En sistemas operativos, la cola se utiliza para almacenar procesos en espera de ser ejecutados. En redes de computadoras, las colas se utilizan para almacenar paquetes en espera de ser transmitidos. En sistemas de impresión, las colas se utilizan para almacenar documentos en espera de ser impresos.\n");
